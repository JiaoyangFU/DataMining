...
def make_prediction(restaurant_dict, restaurant, user):
    similar_rest = topMatches(restaurant_dict, restaurant, n = 150, similarity=sim_pearson)
    numerator = 0.
    denominator = 0.
...
def topMatches(restaurant_dict,item_to_predict,n=5,similarity=sim_pearson):    
